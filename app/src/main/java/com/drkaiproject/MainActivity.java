...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.w("sharedpreference_mainactivity", sf.getString("user_id", "null"));
        area_num = sf.getString("user_area", "1");
            ...
            if (SqliteFunction.today > sf.getInt("today", 20200000)) {
                ...
                try {
                    ...
                    try {
                        ...
                        Document doc = Jsoup.connect(Constants.kma_server).get();

                        Log.w("stage3", "onPostexecute");
                        ...
                        editor.commit();
                        Log.w("result_cold sf complete : " + SqliteFunction.today, sf.getString("result_cold", "null"));
                    } catch (IOException e) {
                        e.printStackTrace();
                    } catch (JSONException e) {
                        e.printStackTrace();
