...
public class RMTDiag2Activity extends AppCompatActivity {
    private ZoomSDKAuthenticationListener authListener = new ZoomSDKAuthenticationListener() {
        ...
        public void onZoomSDKLoginResult(long result) {
            if (result == ZoomAuthenticationError.ZOOM_AUTH_ERROR_SUCCESS) {
                ...
                startMeeting(RMTDiag2Activity.this);
            }
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rmtdiag2);
    ...
    public void initializeSdk(Context context) {
        ...
        params.appKey = "egQDrrm5mLIXX3ogQ6lapwtIB4pmYa52tqUQ"; // TODO: Retrieve your SDK key and enter it here
        params.appSecret = "ujarcb4IHMt5VaS9OZPp5Zo94keRPZ7KkE4K"; // TODO: Retrieve your SDK secret and enter it here
    ...
    public void joinMeeting(Context context, String meetingNumber, String password) {
        ...
        params.displayName = "pu1et"; // TODO: Enter your name
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (numberInput != null && numberInput.getText() != null && passwordInput != null && passwordInput.getText() != null) {
                ...
                if (meetingNumber.trim().length() > 0 && password.trim().length() > 0) {
                    joinMeeting(RMTDiag2Activity.this, meetingNumber, password);
                }
            }
            dialog.dismiss();
        }
