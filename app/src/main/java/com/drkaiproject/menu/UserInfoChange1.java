...
public class UserInfoChange1 extends AppCompatActivity {
    //데이터
    ...
    String bmi, history_cancer, depSum;

    //라디오그룹
    RadioGroup radio_BH2_61,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userinfochange1);
        ...
        go_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (textToString()) {
                    ...
                    Intent intent = new Intent(UserInfoChange1.this, UserInfoChange2.class);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (!resObject.getString("result").equals("1")) throw new Exception();
                        ...
                        // 개인정보
                        jsonObject.put("name",resObject.getString("name"));
                        jsonObject.put("gender",resObject.getString("gender"));
                        jsonObject.put("area",resObject.getString("area"));
                        jsonObject.put("age",resObject.getString("age"));
                        jsonObject.put("carstairs","4"); // user에 없음
                        jsonObject.put("check",resObject.getString("checked"));
                        jsonObject.put("depSum",resObject.getString("depSum"));
                        ...
                        depSum = resObject.getString("depSum");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
